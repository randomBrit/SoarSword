...
namespace HeneGames.Airplane
{
    ...
    public class SimpleAirPlaneController : MonoBehaviour
    {
        ...
        private void FlyingUpdate()
        {
            ...
            //crashing logic relocated to simpleAirPlaneCollider
        }
        ...
        #region privates called from publics
        private void DefaultTriggerAction()
        {
            Debug.Log("sword default trigger");
        }
        ...
        public virtual void triggerHit(string tag)
        {
            switch (tag)
            {
                case "Finish":
                ...
                default:
                    // Handle generic trigger behavior
        ...
        public virtual void Crash(bool updateTime = false)
        {
            //Invoke action
            crashAction?.Invoke();
